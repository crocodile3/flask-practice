...
/**
 * Extend an object with the member of another
...
/**
 * Extend a prototyped class by new member
 * @param {Object} parent
...
SVGRenderer.prototype = {
	...
	/**
	 * Destroys the renderer and its allocated member.
	 */
	destroy: function () {
		var renderer = this,
...
Highcharts.VMLElement = VMLElement = {
	...
	/**
	 * Extend element.destroy by removing it from the clip member array
	 */
	destroy: function () {
		if (this.destroyClip) {
			this.destroyClip();
...
var VMLRendererExtension = { // inherit SVGRenderer
	 ...
	 * for setting the CSS style to all associated member.
	 *
	 * @param {Number} x
	 * @param {Number} y
	 * @param {Number} width
	...
	clipRect: function (x, y, width, height) {
		...
		return extend(clipRect, {
			...
			// used in attr and animation to update the clipping of all member
...
Chart.prototype = {
	...
	getAxes: function () {
		...
		// make sure the options are arrays and add some member
